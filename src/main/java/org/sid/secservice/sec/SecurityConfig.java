...
//         http.authorizeRequests().antMatchers("/h2-console/**","/refreshToken/**","/login","/saveUser","/h","/getTest","/*" ).permitAll();
...
//         config.addAllowedOrigin("http://localhost:61226"); // Allow all origins, you can configure specific origins here
